...
class Settings(BaseSettings):
    ...
    MONGODB_CATEGORIES_COLLECTION: str = os.getenv("MONGODB_CATEGORIES_COLLECTION", "categories")
    ...
    # Cài đặt cho Kafka
    KAFKA_BOOTSTRAP_SERVERS: str = os.getenv("KAFKA_BOOTSTRAP_SERVERS", "localhost:9094").split(",")
settings = Settings()